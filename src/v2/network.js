...
export class Network extends NanoApi {
    ...
    constructor(config) {
        ...
        this._eventServer.onRequest('disconnect', (state, reason) => this.disconnect(reason));
        ...
        this._eventServer.onRequest('forgetBalances', (state, arg) => this.forgetBalances(arg));
        ...
        this._eventServer.onRequest('addConsensusChangedListener', (state, eventName) => this.addConsensusChangedListener(eventName));
        this._eventServer.onRequest('removeListener', (state, handle) => this.removeListener(handle));
    }
